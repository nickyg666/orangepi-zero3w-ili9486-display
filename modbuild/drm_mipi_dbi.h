...
struct mipi_dbi_dev {
	...
	/**
	 * @scale: downscale factor (1 = no scaling). When > 1, the DRM
	 *         mode is scale times the physical panel resolution and
	 *         every flushed rect is box-filtered down to panel size.
	 */
	unsigned int scale;
